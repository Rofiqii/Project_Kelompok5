...
class CustomButton extends StatelessWidget {
  ...
  final double radius;
  final IconData? icon;
  const CustomButton({super.key, this.onPressed, required this.buttonText, this.transparent=false, this.margin, this.height, this.width=280, this.fontSize, this.radius=5, this.icon});
      ...
      child: SizedBox(
        ...
        child: TextButton(
          ...
          child: Row(
            ...
            children: [
              icon!=null?Padding(padding: EdgeInsets.only(right: Dimensions.width10/2),
